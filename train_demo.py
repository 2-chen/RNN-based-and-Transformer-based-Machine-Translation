...
def main():
    ...
    if success:
        ...
        print("\n可以使用以下命令测试推理：")
        if args.model_type in ['rnn', 'all']:
            print("  python inference.py --model_type rnn --checkpoint checkpoints/demo_rnn/rnn_best.pt --input '你好世界'")
        if args.model_type in ['transformer', 'all']:
            print("  python inference.py --model_type transformer --checkpoint checkpoints/demo_transformer/transformer_best.pt --input '你好世界'")
